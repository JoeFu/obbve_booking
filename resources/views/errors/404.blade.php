...
<!-- Navbar Transparent -->
{{--<nav class="navbar navbar-expand-lg position-absolute top-0 z-index-3 w-100 shadow-none my-3  bg-transparent ">--}}
{{--    <div class="container">--}}
{{--        <a class="navbar-brand  text-dark " href="https://demos.creative-tim.com/soft-ui-design-system-pro/presentation.html" rel="tooltip" title="Designed and Coded by Creative Tim" data-placement="bottom" target="_blank">--}}
{{--            ####--}}
{{--        </a>--}}
...
{{--                    <a class="nav-link ps-2 d-flex justify-content-between cursor-pointer align-items-center text-dark" id="dropdownMenuPages" data-bs-toggle="dropdown" aria-expanded="false">--}}
{{--                        Pages--}}
...
{{--                </li>--}}
{{--                <li class="nav-item dropdown dropdown-hover mx-2">--}}
{{--                    <a class="nav-link ps-2 d-flex justify-content-between cursor-pointer align-items-center text-dark" id="dropdownMenuAccount" data-bs-toggle="dropdown" aria-expanded="false">--}}
{{--                        Account--}}
{{--                        <img src="/assets/img/down-arrow-dark.svg" alt="down-arrow" class="arrow ms-1">--}}
{{--                    </a>--}}
...
{{--                </li>--}}
{{--                <li class="nav-item dropdown dropdown-hover mx-2">--}}
{{--                    <a class="nav-link ps-2 d-flex justify-content-between cursor-pointer align-items-center text-dark" id="dropdownMenuBlocks" data-bs-toggle="dropdown" aria-expanded="false">--}}
{{--                        Blocks--}}
{{--                        <img src="/assets/img/down-arrow-dark.svg" alt="down-arrow" class="arrow ms-1">--}}
{{--                    </a>--}}
...
{{--                </li>--}}
{{--                <li class="nav-item dropdown dropdown-hover mx-2">--}}
{{--                    <a class="nav-link ps-2 d-flex justify-content-between cursor-pointer align-items-center text-dark" id="dropdownMenuDocs" data-bs-toggle="dropdown" aria-expanded="false">--}}
{{--                        Docs--}}
{{--                        <img src="/assets/img/down-arrow-dark.svg" alt="down-arrow" class="arrow ms-1">--}}
{{--                    </a>--}}
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 my-auto">
                ...
                <button type="button" class="btn bg-gradient-dark mt-4" onclick="window.location.href='{{route('index')}}'">Go to Homepage</button>
            </div>
