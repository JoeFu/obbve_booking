...
<head>
    ...
    <title>
        Soft UI Design System PRO by Creative Tim
    </title>
    ...
    <meta itemprop="name" content="Soft UI Design System Pro by Creative Tim">
    <meta itemprop="description" content="Most complex and innovative Design System Made by Creative Tim. Check our latest Premium Bootstrap 5 UI Kit.">
    <meta itemprop="image" content="https://s3.amazonaws.com/creativetim_bucket/products/414/thumb/opt_sds_thumbnail.png">
    <!-- Twitter Card data -->
    ...
    <link href="/assets/css/nucleo-svg.css" rel="stylesheet" />
    <!-- CSS Files -->
    <link id="pagestyle" href="/assets/css/soft-design-system-pro.min.css?v=1.0.3" rel="stylesheet" />
...
{{--                <li class="nav-item">--}}
{{--                    <a href="https://www.creative-tim.com/product/soft-ui-design-system-pro#pricingCard" class="btn btn-sm  bg-gradient-primary  btn-round mb-0 me-1">Buy Now</a>--}}
{{--                </li>--}}
{{--            </ul>--}}
        </div>
    </div>
...
<header>
    <div class="page-header section-height-50" style="background-image: url('/assets/img/seppeltsfield-road-barossa.jpg')">
        <span class="mask bg-gradient-dark"></span>
        <div class="container">
            <div class="row">
                <div class="col-lg-8 mx-auto text-white text-center">
                    <h2 class="text-white">Book your premium accommodation here</h2>
                    <p class="lead">We offer you best quality trip and services.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row bg-white shadow-lg mt-n6 border-radius-md pb-4 p-3 mx-sm-0 mx-1 position-relative">
            ...
            <div class="col-lg-3 mt-lg-n2 mt-2">
                <label class="">Check-in to Check-out</label>
            ...
            <div class="col-lg-3 mt-lg-n2 mt-2">
                ...
                <select class="form-control" name="choices-button" id="choices-button" placeholder="Guests">
            ...
            <div class="col-lg-3 mt-lg-n2 mt-2">
                ...
                <select class="form-control" name="choices-remove-button" id="choices-remove-button" placeholder="Room Type">
                    <option value="Choice 1" selected="">Blickinstal Studio</option>
                    <option value="Choice 2">Blickinstal Lodge</option>
                </select>
            </div>
            ...
            <div class="col-lg-3 mt-lg-n2 mt-2">
                <label class="">&nbsp;</label>
                <button type="button" class="btn bg-gradient-dark w-100 mb-0">Check rooms</button>
            </div>
        </div>
    </div>
</header>
...
<section class="py-7 bg-gradient-faded-dark position-relative overflow-hidden">
    ...
    <div class="container pt-6 pb-5 position-relative z-index-3">
        <div class="row">
            <div class="col-md-6 mx-auto text-center">
                <span class="badge badge-white text-dark mb-2">Reviews</span>
                <h2 class="text-white mb-3">Some reviews from our guests</h2>
                <h5 class="text-white font-weight-light">
                    We will show some of our customers’ evaluations from Google Review, Booking.com, Tripe Advistor, etc.
                </h5>
            </div>
        </div>
        <div class="row mt-8">
                ...
                <div class="accordion" id="accordionRental">
                    <div class="accordion-item mb-3">
                        <h5 class="accordion-header" id="headingOne">
                            <button class="accordion-button border-bottom font-weight-bold text-left" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                Does Blickinstal Barossa Valley Retreat offer free cancellation for a full refund?
                        ...
                        <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionRental">
                            <div class="accordion-body text-sm opacity-8">
                                Yes, Blickinstal Barossa Valley Retreat does have fully refundable rooms available to book on our site, which can be cancelled up to a few days before check-in.
                    ...
                    <div class="accordion-item mb-3">
                        <h5 class="accordion-header" id="headingTwo">
                            <button class="accordion-button border-bottom font-weight-bold text-left" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                    ...
                    <div class="accordion-item mb-3">
                        <h5 class="accordion-header" id="headingThree">
                            <button class="accordion-button border-bottom font-weight-bold text-left" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                    ...
                    <div class="accordion-item mb-3">
                        <h5 class="accordion-header" id="headingFour">
                            <button class="accordion-button border-bottom font-weight-bold text-left" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                    ...
                    <div class="accordion-item mb-3">
                        <h5 class="accordion-header" id="headingFifth">
                            <button class="accordion-button border-bottom font-weight-bold text-left" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFifth" aria-expanded="false" aria-controls="collapseFifth">
...
<!-- -------- START CONTENT 10 w/ card over right bg image ------- -->
    ...
    <div class="container">
        <div class=" row">
            <div class="col-md-3 mb-4 ms-auto">
                <div>
                    <h6 class="text-gradient text-primary font-weight-bolder">Blickinstal Booking System</h6>
                </div>
                <div>
                    <h6 class="mt-3 mb-2 opacity-8">Managed by VAM Australia Pty Ltd</h6>
            ...
            <div class="col-12">
                <div class="text-center">
                    <p class="my-4 text-sm">
                        Vam Australia Pty Ltd. All rights reserved. Copyright ©  2020 -
                        <script>
                            document.write(new Date().getFullYear())
                        </script>. Website by <a href="#" target="_blank">Joe Fu</a>.
                    </p>
                </div>
            </div>
        </div>
...
<script src="/assets/js/soft-design-system-pro.min.js?v=1.0.3" type="text/javascript"></script>
<script>
    //
    //
</script>
